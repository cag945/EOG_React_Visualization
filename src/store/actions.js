...
export const FETCH_DRONE_LOCATIONS = "COMMAND/FETCH_DRONE_LOCATIONS";
...
export const DRONE_LOCATIONS_RECEIVED = "EVENT/DRONE_LOCATIONS_RECEIVED";
export const DRONE_LOCATIONS_FAILED = "EVENT/DRONE_LOCATIONS_FAILED";
